...
<Tabs>
  <TabItem label="Execute Commands">
	...
	<TabItem label="Interactive Terminals">
		...
		Create interactive terminal sessions with PTY support. Learn more: [Interactive Terminals](/sandbox/guides/interactive-terminals/).
	</TabItem>
...
<Feature header="Interactive terminal sessions" href="/sandbox/guides/interactive-terminals/" cta="Learn about PTY support">

Create interactive terminal sessions with full PTY support. Enable interactive shells, text editors, and terminal user interface applications with real-time input and output.
